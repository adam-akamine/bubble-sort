...
describe('bubbleSort()', function () {
  ...
  it('should return 0 if array has length 1', function () {
    var arr = [0];
    expect(bubbleSort(arr)).to.equal(0);
  });
  ...
  // it('should sort 100 values with duplicates from lowest to highest', function() {
  //   var arr = [];
  //   var value;
  //   for(var i = 0; i < 101; i++) {
